...
Summary(pl.UTF-8):	DirectFBSee - przeglądarka obrazków i filmów dla linuksowego framebuffera
Name:		DFBSee
Version:	0.7.4
Release:	4
License:	GPL
...
DirectFBSee to przeglądarka obrazków i filmów dla linuksowego
framebuffera. dfbsee otwiera podany plik i próbuje dostępnych modułów
dostarczających grafikę i obraz DirectFB. Aktualnie są to PNG, JPEG,
GIF oraz MPEG lub urządzenie Video4Linux.
